...
const Sidebar = ({ view, setView, setGlobalPlaylistId }) => {
  ...
  return (
    <div className="w-64 text-neutral-400 grow-0 shrink-0 h-screen no-scrollbar overflow-y-scroll border-r border-neutral-900 p-5 text-sm hidden md:inline-flex">
